...
<p style = "font-size:24px;"> Finally, a **two-way ANOVA** (yes, also a glorified regression) is used by people when there are categorical 2 IVs (usually two grouping variables). </p>
...
:::{.fragment fragment-index="5"}
<li> **Main effect of Gender:** Weight after 3 months changes significantly depending on *gender*, *F*(1, 4) = 75.57, *p*<.001. </li>
:::

:::{.fragment fragment-index="6"}
<li>**Main effect of Diet:** Weight after 3 months changes significantly depending on the *type of diet* that participants are assigned to, *F*(1, 4) = 217.29, *p*<.001. </li>
:::

:::{.fragment fragment-index="7"}
<li>**Interaction effect of Gender**$\times$**Diet:** The effect of the *type of diet* on weight after 3 months, **changes significantly** <u>depending on what gender participants are</u>, *F*(1, 4) = 51.57, *p* = 002. </li>
:::
