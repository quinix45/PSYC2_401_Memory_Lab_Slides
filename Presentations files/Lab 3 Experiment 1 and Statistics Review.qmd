...
<p style = "font-size:24px;"> Finally, a **two-way ANOVA** (yes, also a regression) is generally used when there are categorical 2 IVs (usually two grouping variables). </p>
